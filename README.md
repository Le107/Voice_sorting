...
If you have long audio files with multiple voices (dialogues), then put them in the 'work' folder, the script will slice them into the 'input' folder.
...
Если у вас длинные аудиофайлы с несколькими голосами (диалогами), то поместите их в папку 'work', скрипт их нарежет в папку 'input'.
