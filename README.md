...
Если у вас длинные аудиофайлы с несколькими голосами (диалогами), то поместите их в папку `work`, скрипт их нарежет в папку `input`. Для лучшей нарезки, пропустите через https://github.com/Anjok07/ultimatevocalremovergui
